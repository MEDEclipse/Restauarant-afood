...
const Hero47 = ({
  ...
  buttons = {
    primary: {
      ...
      url: "https://d2tvomu9ndhyfk.cloudfront.net/",
    },
    secondary: {
  ...
  return (
    <section className="bg-background p-10 lg:p-20">
      <div className="container flex flex-col items-center gap-10 lg:my-0 lg:flex-row">
        <div className="flex flex-col gap-7 lg:w-2/3">
          <h2 className="text-foreground text-2xl font-semibold md:text-5xl lg:text-6xl">
            <span>{heading}</span>
